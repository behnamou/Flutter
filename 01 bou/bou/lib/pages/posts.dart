...
class MyPosts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // final tabsRouter = AutoTabsRouter.of(context);h
    return Expanded(
      child: Stack(
        children: [
          _MyPosts(),
...
class _MyPosts extends StatelessWidget {
  final List<Post> posts = [
    ...
    Post(
        ...
        authorName: 'Behnam'),
    Post(
        text: "تست در حد یک خط",
        image: "assets/my_files/4.JPG",
        authorName: 'Farzam'),
  ];
          ...
          children: [
            GestureDetector(
                onTap: () => {
                      ...
                      // AutoRouter.of(context).push(OtherAccountsRoute())
                    },
                child: Container(
                  color: Colors.white,
                  width: width,
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () => {
                        ...
                        // AutoRouter.of(context).navigate(OtherAccountsRoute()),
                      },
                      child: ClipOval(
                        child: Image.asset(
